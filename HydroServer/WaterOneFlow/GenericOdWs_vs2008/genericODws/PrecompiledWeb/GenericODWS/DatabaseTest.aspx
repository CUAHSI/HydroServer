<%@ page language="C#" autoeventwireup="true" inherits="DatabaseTest, App_Web_e59tjmlb" %>
...
<body>
  ...
  <div>
      ...
      <asp:LoginView ID="LoginView1" runat="server">
          <LoggedInTemplate>
              This should display 10 sites<div>
            ...
            SelectCommand="SELECT TOP 10 [SiteCode], [SiteName] FROM [Sites]"></asp:SqlDataSource>
                  ...
                  <div>
                      This should display a 10 variables
                  </div>
            ...
            SelectCommand="SELECT TOP 10 [VariableCode], [variableName] FROM [Variables]"></asp:SqlDataSource>
                  ...
                  <div>
                      This should display a 10 records from the series catalog</div>
