...
#Region " Constructors "
    ...
    Sub New(ByVal intSiteid As Integer, ByVal strSiteCode As String, ByVal strSiteName As String, ByVal strSiteType As String, ByVal intVariableid As Integer, ByVal strVariableCode As String, ByVal strVariableName As String, _
        ...
        Try
            If DatabaseFunctions.GetODMVersion("") = "1.1.1" Then
                mobjSite = New Site(intSiteid, strSiteCode, strSiteName, strSiteType, strDatabaseName)
            Else
    ...
    Sub New(ByVal e_seriesid As Integer, ByVal e_databasename As String)
        Try
            ...
            If Not (seriesData Is Nothing) And (seriesData.Rows.Count > 0) Then
                mintSeriesid = CInt(seriesData.Rows(0).Item(db_fld_SCSeriesid))
                If DatabaseFunctions.GetODMVersion(e_databasename) = "1.1.1" Then
                    mobjSite = New Site(CInt(seriesData.Rows(0).Item(db_fld_SCSiteid)), seriesData.Rows(0).Item(db_fld_SCSiteCode).ToString, seriesData.Rows(0).Item(db_fld_SCSiteName).ToString, seriesData.Rows(0).Item(db_fld_SCSiteType).ToString, e_databasename)
                Else
