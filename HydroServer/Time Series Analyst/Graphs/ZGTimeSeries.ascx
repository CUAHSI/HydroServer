<%@ Control language="VB" autoeventwireup="false" codefile="ZGTimeSeries.ascx.vb" Inherits="Graphs_ZGTimeSeries" %>
<%@ Register Assembly="ZedGraph.Web" Namespace="ZedGraph.Web" TagPrefix="cc1" %>
<cc1:ZedGraphWeb id="TimeSeriesPlot" runat="server" height="400" width="520" BarType="Cluster" LineType="Normal" RenderedImagePath="~/images" Title="No Data To Plot">
