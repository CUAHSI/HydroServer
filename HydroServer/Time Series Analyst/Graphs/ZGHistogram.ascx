<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ZGHistogram.ascx.vb" Inherits="Graphs_ZGHistogram" %>
<%@ Register Assembly="ZedGraph.Web" Namespace="ZedGraph.Web" TagPrefix="cc1" %>
<cc1:ZedGraphWeb id="HistogramPlot" runat="server"  Height="400" Width="520" BarType="Cluster" LineType="Normal" RenderedImagePath="~/images" Title="No Data To Plot">
    <XAxis AxisColor="Black" Cross="0" CrossAuto="True" IsOmitMag="False" IsPreventLabelOverlap="True"
        ...
        IsZeroLine="False" MinSpace="0" Title="Variable" Type="Text">
