<%@ Control Language="VB" AutoEventWireup="false" CodeFile="ZGProbability.ascx.vb" Inherits="Graphs_ZGProbability" %>
<%@ Register Assembly="ZedGraph.Web" Namespace="ZedGraph.Web" TagPrefix="cc1" %>
<cc1:ZedGraphWeb id="ProbabilityPlot" runat="server"  Height="400" Width="520" BarType="Cluster" LineType="Normal" RenderedImagePath="~/images" Title="No Data To Plot">
