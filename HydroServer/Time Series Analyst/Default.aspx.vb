...
#End Region
            ...
            Try
                ...
                If (objSeriesInfoTable.Rows.Count > 0) Then
                    ...
                    strSeriesInfo = "<b>SiteCode: </b>" & Convert.ToString(objSeriesInfoTable.Rows(0).Item("SiteCode")) & "<br>" & _
                                    "<b>SiteName: </b>" & Convert.ToString(objSeriesInfoTable.Rows(0).Item("SiteName")) & "<br>" & _
                                    "<b>VariableCode: </b>" & Convert.ToString(objSeriesInfoTable.Rows(0).Item("VariableCode")) & "<br>" & _
    ...
    Protected Sub Query()
        Try
            ...
            Dim sql As String = "SELECT CONVERT(VARCHAR(20), [BeginDateTime], 100) + ' - ' + CONVERT(VARCHAR(20), [EndDateTime], 100) AS DateTimeRange, * FROM SeriesCatalog WHERE "
