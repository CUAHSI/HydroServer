...
namespace HydroServer.Proxy
{
	...
	[System.Data.Linq.Mapping.DatabaseAttribute(Name="USUICEWATERNode")]
    ...
    partial void InsertMapServerTypeCV(MapServerTypeCV instance);
    partial void UpdateMapServerTypeCV(MapServerTypeCV instance);
    partial void DeleteMapServerTypeCV(MapServerTypeCV instance);
    ...
    partial void DeleteODMDatabase(ODMDatabase instance);
		...
		public LINQDataContext() : 
				base(global::HydroServer.Proxy.Properties.Settings.Default.USUICEWATERNodeConnectionString, mappingSource)
		{
			OnCreated();
		}
		...
		public System.Data.Linq.Table<MapServerMetadata> MapServerMetadatas
		{
			get
			{
				return this.GetTable<MapServerMetadata>();
			}
		}
		...
		public System.Data.Linq.Table<MapServerTypeCV> MapServerTypeCVs
		{
			get
			{
				return this.GetTable<MapServerTypeCV>();
			}
		}
    ...
    partial void OnEmailAddressChanged();
		...
		[Column(Storage="_OrganizationName", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_MailingAddress", DbType="NVarChar(255)")]
		...
		[Column(Storage="_Country", DbType="NVarChar(255)")]
		...
		[Column(Storage="_PostalCode", DbType="NVarChar(255)")]
		...
		[Column(Storage="_FaxNumber", DbType="NVarChar(255)")]
		...
		[Column(Storage="_PhoneNumber", DbType="NVarChar(255)")]
		...
		[Column(Storage="_EmailAddress", DbType="NVarChar(255)")]
		...
		[Association(Name="Contact_MapService", Storage="_MapServices", ThisKey="ContactID", OtherKey="MetadataContactID")]
		...
		[Association(Name="Contact_MapService1", Storage="_MapServices1", ThisKey="ContactID", OtherKey="DatasetContactID")]
		...
		[Association(Name="Contact_ODMDatabase", Storage="_ODMDatabases", ThisKey="ContactID", OtherKey="MetadataContactID")]
		...
		[Association(Name="Contact_ODMDatabase1", Storage="_ODMDatabases1", ThisKey="ContactID", OtherKey="DatasetContactID")]
    ...
    partial void OnRegionMapCSSURLChanged();
		...
		[Column(Storage="_RegionTitle", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_NorthExtent", DbType="Float NOT NULL")]
		...
		[Column(Storage="_EastExtent", DbType="Float NOT NULL")]
		...
		[Column(Storage="_SouthExtent", DbType="Float NOT NULL")]
		...
		[Column(Storage="_WestExtent", DbType="Float NOT NULL")]
		...
		[Column(Storage="_RegionDescription", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_RegionMapCSSURL", DbType="NVarChar(500)")]
	...
	[Table(Name="dbo.MapServerMetadata")]
	public partial class MapServerMetadata
	{
		...
		public MapServerMetadata()
		{
		}
		
		[Column(Storage="_MapServerID", DbType="Int NOT NULL")]
		...
		[Column(Storage="_MetadataTitle", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_MetadataContent", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
	...
	public partial class MapServer : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private EntityRef<MapServerTypeCV> _MapServerTypeCV;
    ...
    partial void OnPasswordChanged();
		...
		{
			this._MapServices = new EntitySet<MapService>(new Action<MapService>(this.attach_MapServices), new Action<MapService>(this.detach_MapServices));
			this._MapServerTypeCV = default(EntityRef<MapServerTypeCV>);
			OnCreated();
		}
		
		[Column(Storage="_MapServerID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int MapServerID
		{
			get
			{
		...
		[Column(Storage="_MapServerName", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ConnectionURL", DbType="NVarChar(500) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_MapServerType", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		public string MapServerType
		{
			...
			set
			{
				...
				{
					if (this._MapServerTypeCV.HasLoadedOrAssignedValue)
					{
		...
		[Column(Storage="_Domain", DbType="NVarChar(255)")]
		...
		[Association(Name="MapServer_MapService", Storage="_MapServices", ThisKey="MapServerID", OtherKey="MapServerID")]
		public EntitySet<MapService> MapServices
		{
			get
			{
		...
		[Association(Name="MapServerTypeCV_MapServer", Storage="_MapServerTypeCV", ThisKey="MapServerType", OtherKey="MapServerType", IsForeignKey=true)]
		public MapServerTypeCV MapServerTypeCV
		{
			get
			{
				return this._MapServerTypeCV.Entity;
			}
			set
			{
				MapServerTypeCV previousValue = this._MapServerTypeCV.Entity;
				if (((previousValue != value) 
							|| (this._MapServerTypeCV.HasLoadedOrAssignedValue == false)))
				{
					this.SendPropertyChanging();
					if ((previousValue != null))
					{
						this._MapServerTypeCV.Entity = null;
						previousValue.MapServers.Remove(this);
					}
					this._MapServerTypeCV.Entity = value;
					if ((value != null))
					{
						value.MapServers.Add(this);
						this._MapServerType = value.MapServerType;
					}
					else
					{
						this._MapServerType = default(string);
					}
					this.SendPropertyChanged("MapServerTypeCV");
				}
			}
		}
	...
	[Table(Name="dbo.MapServerTypeCV")]
	public partial class MapServerTypeCV : INotifyPropertyChanging, INotifyPropertyChanged
	{
		...
		private string _SampleServerConnectionUrl;
		
		private string _SampleMapConnection;
		
		private bool _HasDomain;
		
		private bool _HasUsername;
		
		private EntitySet<MapServer> _MapServers;
    ...
    partial void OnSampleServerConnectionUrlChanging(string value);
    partial void OnSampleServerConnectionUrlChanged();
    partial void OnSampleMapConnectionChanging(string value);
    partial void OnSampleMapConnectionChanged();
    partial void OnHasDomainChanging(bool value);
    partial void OnHasDomainChanged();
    partial void OnHasUsernameChanging(bool value);
    partial void OnHasUsernameChanged();
    #endregion
		
		public MapServerTypeCV()
		{
			this._MapServers = new EntitySet<MapServer>(new Action<MapServer>(this.attach_MapServers), new Action<MapServer>(this.detach_MapServers));
			OnCreated();
		}
		
		[Column(Storage="_MapServerType", DbType="NVarChar(255) NOT NULL", CanBeNull=false, IsPrimaryKey=true)]
		public string MapServerType
		{
			get
			{
		...
		[Column(Storage="_SampleServerConnectionUrl", DbType="NVarChar(500) NOT NULL", CanBeNull=false)]
		public string SampleServerConnectionUrl
		{
			get
			{
				return this._SampleServerConnectionUrl;
			}
			set
			{
				if ((this._SampleServerConnectionUrl != value))
				{
					this.OnSampleServerConnectionUrlChanging(value);
					this.SendPropertyChanging();
					this._SampleServerConnectionUrl = value;
					this.SendPropertyChanged("SampleServerConnectionUrl");
					this.OnSampleServerConnectionUrlChanged();
				}
			}
		}
		
		[Column(Storage="_SampleMapConnection", DbType="NVarChar(500) NOT NULL", CanBeNull=false)]
		public string SampleMapConnection
		{
			get
			{
				return this._SampleMapConnection;
			}
			set
			{
				if ((this._SampleMapConnection != value))
				{
					this.OnSampleMapConnectionChanging(value);
					this.SendPropertyChanging();
					this._SampleMapConnection = value;
					this.SendPropertyChanged("SampleMapConnection");
					this.OnSampleMapConnectionChanged();
				}
			}
		}
		
		[Column(Storage="_HasDomain", DbType="Bit NOT NULL")]
		public bool HasDomain
		{
			...
			set
			{
				if ((this._HasDomain != value))
				{
					this.OnHasDomainChanging(value);
					this.SendPropertyChanging();
					this._HasDomain = value;
					this.SendPropertyChanged("HasDomain");
					this.OnHasDomainChanged();
				}
			}
		}
		
		[Column(Storage="_HasUsername", DbType="Bit NOT NULL")]
		public bool HasUsername
		{
			...
			set
			{
				if ((this._HasUsername != value))
				{
					this.OnHasUsernameChanging(value);
					this.SendPropertyChanging();
					this._HasUsername = value;
					this.SendPropertyChanged("HasUsername");
					this.OnHasUsernameChanged();
				}
			}
		}
		
		[Association(Name="MapServerTypeCV_MapServer", Storage="_MapServers", ThisKey="MapServerType", OtherKey="MapServerType")]
		public EntitySet<MapServer> MapServers
		{
			get
			{
				return this._MapServers;
			}
			set
			{
				this._MapServers.Assign(value);
			}
		}
		...
		private void attach_MapServers(MapServer entity)
		{
			this.SendPropertyChanging();
			entity.MapServerTypeCV = this;
		}
		
		private void detach_MapServers(MapServer entity)
		{
			this.SendPropertyChanging();
			entity.MapServerTypeCV = null;
		}
	}
	
	[Table(Name="dbo.MapServiceMetadata")]
	public partial class MapServiceMetadata
	{
		...
		[Column(Storage="_MapServiceID", DbType="Int NOT NULL")]
    ...
    partial void OnOnlineResourceChanged();
		...
		[Column(Storage="_MapServiceID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int MapServiceID
		{
			get
			{
		...
		[Column(Storage="_MapConnection", DbType="NVarChar(500) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ReferenceDate", DbType="DateTime NOT NULL")]
		...
		[Column(Storage="_TopicCategory", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_MetadataContactID", DbType="Int NOT NULL")]
		...
		[Column(Storage="_DatasetContactID", DbType="Int")]
		...
		[Column(Storage="_SpatialResolution", DbType="NVarChar(255)")]
		...
		[Column(Storage="_DistributionFormat", DbType="NVarChar(255)")]
		...
		[Column(Storage="_SpatialRepresentationType", DbType="NVarChar(255)")]
		...
		[Column(Storage="_SpatialReferenceSystem", DbType="NVarChar(255)")]
		...
		[Column(Storage="_LineageStatement", DbType="NVarChar(MAX)")]
		...
		[Column(Storage="_OnlineResource", DbType="NVarChar(500)")]
		...
		[Association(Name="Contact_MapService", Storage="_Contact", ThisKey="MetadataContactID", OtherKey="ContactID", IsForeignKey=true)]
		...
		[Association(Name="Contact_MapService1", Storage="_Contact1", ThisKey="DatasetContactID", OtherKey="ContactID", IsForeignKey=true)]
		...
		[Association(Name="MapServer_MapService", Storage="_MapServer", ThisKey="MapServerID", OtherKey="MapServerID", IsForeignKey=true)]
	...
	[Table(Name="dbo.ODMDatabaseMetadata")]
	public partial class ODMDatabaseMetadata
	{
		...
		[Column(Storage="_DatabaseID", DbType="Int NOT NULL")]
    ...
    partial void OnWaterOneFlowWSDLChanged();
		...
		[Column(Storage="_DatabaseID", AutoSync=AutoSync.OnInsert, DbType="Int NOT NULL IDENTITY", IsPrimaryKey=true, IsDbGenerated=true)]
		public int DatabaseID
		{
			get
			{
		...
		[Column(Storage="_ServerAddress", DbType="NVarChar(500) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_DatabaseName", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ODMUser", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_ODMPassword", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_MapMarkerURL", DbType="NVarChar(500)")]
		...
		[Column(Storage="_SpatialReferenceSystem", DbType="NVarChar(255) NOT NULL", CanBeNull=false)]
		public string SpatialReferenceSystem
		{
			get
			{
		...
		[Column(Storage="_Citation", DbType="NVarChar(MAX) NOT NULL", CanBeNull=false)]
		...
		[Column(Storage="_WaterOneFlowWSDL", DbType="NVarChar(500) NOT NULL", CanBeNull=false)]
		...
		[Association(Name="Contact_ODMDatabase", Storage="_Contact", ThisKey="MetadataContactID", OtherKey="ContactID", IsForeignKey=true)]
		public Contact Contact
		{
			get
			{
		...
		[Association(Name="Contact_ODMDatabase1", Storage="_Contact1", ThisKey="DatasetContactID", OtherKey="ContactID", IsForeignKey=true)]
		public Contact Contact1
		{
			get
			{
	...
	[Table(Name="dbo.RegionDatabases")]
	...
	[Table(Name="dbo.RegionMapServices")]
	public partial class RegionMapService
	{
		...
		private System.Nullable<int> _TransparencyPercent;
		
		private System.Nullable<bool> _IsVisible;
		
		private System.Nullable<bool> _IsTOC;
		
		private bool _IsBaseMapService;
		...
		[Column(Storage="_TransparencyPercent", DbType="Int")]
		public System.Nullable<int> TransparencyPercent
		{
			get
			{
				return this._TransparencyPercent;
			}
			set
			{
				if ((this._TransparencyPercent != value))
				{
					this._TransparencyPercent = value;
				}
			}
		}
		...
		[Column(Storage="_IsTOC", DbType="Bit")]
		public System.Nullable<bool> IsTOC
		{
			get
			{
				return this._IsTOC;
		...
		[Column(Storage="_IsBaseMapService", DbType="Bit NOT NULL")]
		public bool IsBaseMapService
		{
			get
			{
				return this._IsBaseMapService;
			}
			set
			{
				if ((this._IsBaseMapService != value))
				{
					this._IsBaseMapService = value;
				}
			}
		}
	}
	
	[Table(Name="dbo.RegionMetadata")]
