    ...
    Protected Overrides Function ValidateTable(ByVal connect As SqlClient.SqlConnection, ByVal trans As System.Data.SqlClient.SqlTransaction) As Data.DataTable
        ...
        Try
            ...
            Catch ex As Exception
                LogError("Groups should be unique, but not all of the Groups in your database are unique.<br>Duplicate rows will be allowed for updates into this Groups table.")
            End Try
        ...
        Catch ex As Exception
            ...
            End If
            Throw New ExitError("Groups.ValidateTable(connect, trans)<br> " & ex.Message)
        End Try
