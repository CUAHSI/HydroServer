...
<body>
    ...
    <form id="form1" runat="server">
        <h2>HydroServer Web Data Loader</h2>
        <div class ="container" align="left"> 
            <asp:Label ID="Label1" runat="server" Text="To load a file into the database, click Browse and select a file, then Upload File. "></asp:Label>
            <p align="left">
            ...
            <p>
                <asp:Table ID="tabledata" runat="server"></asp:Table>
            </p>
        </div>
    </form>
</body>
