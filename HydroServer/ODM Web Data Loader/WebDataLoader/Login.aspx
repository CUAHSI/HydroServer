...
<head id="Head1" runat="server" >
    <title>HydroServer Web Data Loader - Login</title>
</head>
<body>
    <form id="form1" runat="server">
        <h1 align="left"><asp:Image ID="Image1" runat="server" ImageUrl="~/Images/HydroServer.png" /></h1>
        <div class ="container">
            ...
            <div  align="left">
                ...
                <asp:Button ID="btnTestConnection" runat="server" OnClick = "btnTestConnection_Click" Text="Test Connection" />
