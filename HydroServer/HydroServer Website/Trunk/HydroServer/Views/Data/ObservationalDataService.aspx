<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Hydroserver.Models.ODMDatabaseModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    <% var m = Model.ODMDatabase;%>
        ...
        <p><strong>Contact: </strong><%=Hydroserver.Models.DataServiceModel.ContactSummary(m.Contact1)%></p>    
        
        <% if (Model.MetadataContact != null) { %>
        <p><strong>Metadata Contact: </strong><%=Hydroserver.Models.DataServiceModel.ContactSummary(Model.MetadataContact)%></p>    
        <%} %>
