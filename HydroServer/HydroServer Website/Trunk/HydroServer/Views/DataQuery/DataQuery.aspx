<%@ Page Title="" Language="C#" MasterPageFile="~/Views/Shared/Site.Master" Inherits="System.Web.Mvc.ViewPage<Hydroserver.Models.DataQueryModel>" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <form method="post">
        ...
        <% if (Model.SeriesCatalog.Count > 0) { %>               
            <% Html.RenderPartial("~/[Embedded Resource]/Hydroserver.Views.DataQuery.DataQueryTable.ascx", Model); %>
            
            <div id="allowDownload">
                <p>
                    <strong>Date/time range:</strong>
                    <label for="StartTime">Start:</label>
                    <input id="StartTime" name="StartTime" value="<%= Model.DataQueryForm.StartTime.ToString() %>" />
                    <label for="EndTime">End:</label>
                    <input id="EndTime" name="EndTime" value="<%= Model.DataQueryForm.EndTime.ToString() %>" />
                    <br />
                    Enter valid date and time values in the following format: <b>mm/dd/yyyy hh:mm am/pm</b>
                    <br />
                    For example: <b>01/26/2004 12:00 am</b>
                </p>
                <p>
                    <strong>Fields to include:</strong>
                    <input type="checkbox" checked="checked" name="selectTime">UTC Time</option>
                    <input type="checkbox" checked="checked" name="selectSite">Site</option>
                    <input type="checkbox" checked="checked" name="selectVariable">Variable</option>
                    <input type="checkbox" checked="checked" name="selectQualifier">Qualifier</option> 
                    ...
                    <input type="checkbox" checked="checked" name="selectOffset">Offset</option>
                    <input type="checkbox" checked="checked" name="selectSource">Source</option>
        ...
        <%} else {%>       
            ...
            <strong style="color: #f00;"><%=ViewData["startTime"] %></strong>
            <strong style="color: #f00;"><%=ViewData["endTime"] %></strong>
        <%} %>
