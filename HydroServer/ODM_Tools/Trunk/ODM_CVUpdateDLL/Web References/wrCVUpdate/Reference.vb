...
Namespace wrCVUpdate
    ...
    Partial Public Class ODMCVService
        ...
        Private GetSiteTypeCVOperationCompleted As System.Threading.SendOrPostCallback
        ...
        '''<remarks/>
        Public Event GetSiteTypeCVCompleted As GetSiteTypeCVCompletedEventHandler
        ...
        '''<remarks/>
        <System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://his.cuahsi.org/his/1.1/ws/GetSiteTypeCV", RequestNamespace:="http://his.cuahsi.org/his/1.1/ws/", ResponseNamespace:="http://his.cuahsi.org/his/1.1/ws/", Use:=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle:=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)>  _
        Public Function GetSiteTypeCV() As String
            Dim results() As Object = Me.Invoke("GetSiteTypeCV", New Object(-1) {})
            Return CType(results(0),String)
        End Function
        
        '''<remarks/>
        Public Overloads Sub GetSiteTypeCVAsync()
            Me.GetSiteTypeCVAsync(Nothing)
        End Sub
        
        '''<remarks/>
        Public Overloads Sub GetSiteTypeCVAsync(ByVal userState As Object)
            If (Me.GetSiteTypeCVOperationCompleted Is Nothing) Then
                Me.GetSiteTypeCVOperationCompleted = AddressOf Me.OnGetSiteTypeCVOperationCompleted
            End If
            Me.InvokeAsync("GetSiteTypeCV", New Object(-1) {}, Me.GetSiteTypeCVOperationCompleted, userState)
        End Sub
        
        Private Sub OnGetSiteTypeCVOperationCompleted(ByVal arg As Object)
            If (Not (Me.GetSiteTypeCVCompletedEvent) Is Nothing) Then
                Dim invokeArgs As System.Web.Services.Protocols.InvokeCompletedEventArgs = CType(arg,System.Web.Services.Protocols.InvokeCompletedEventArgs)
                RaiseEvent GetSiteTypeCVCompleted(Me, New GetSiteTypeCVCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState))
            End If
        End Sub
    ...
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.5420")>  _
    Public Delegate Sub GetSiteTypeCVCompletedEventHandler(ByVal sender As Object, ByVal e As GetSiteTypeCVCompletedEventArgs)
    
    '''<remarks/>
    <System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "2.0.50727.5420"),  _
     System.Diagnostics.DebuggerStepThroughAttribute(),  _
     System.ComponentModel.DesignerCategoryAttribute("code")>  _
    Partial Public Class GetSiteTypeCVCompletedEventArgs
        Inherits System.ComponentModel.AsyncCompletedEventArgs
