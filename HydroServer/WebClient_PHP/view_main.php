...
var long = markerNodes[i].getAttribute("lng");
   ...
   {
 var html = "<b>" + name + "</b> <br/>Site type: "+type+"<br/>Latitude: "+lat+"<br/>Longitude: "+long+"<br/>Source: <a href='"+sourcelink+"' target='_blank'>"+sourcename+"</a><br/><a href='details.php?siteid="+siteid+"'>Click here to visit the site</a>";
