...
if (isset($_POST["SiteID"]) and isset($_POST["VariableID"]) and isset($_POST["MethodID"]) and isset($_POST["SourceID"]) and isset($_POST["QualityControlLevelID"]))
{
   $siteID = $_POST["SiteID"];
   $variableID = $_POST["VariableID"];
   $methodID = $_POST["MethodID"];
   $sourceID = $_POST["SourceID"];
   $qualityControlLevelID = $_POST["QualityControlLevelID"];
   
   $status = update_series_catalog($siteID, $variableID, $methodID, $sourceID, $qualityControlLevelID);
