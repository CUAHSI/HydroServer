...
if ((!$_POST['username']) || (!$_POST['password'])) {
	header("Location: changepassword_teacher.php");
	exit;
}
...
//add the user's data
$sql ="UPDATE $table_name SET password=PASSWORD('$_POST[password]') WHERE username='$_POST[username]'";
...
//add the user's data
$sql2 ="SELECT username FROM $table_name WHERE authority LIKE 'student' ORDER BY username";
