...
if (MetadataChoice =='new'){
	...
	$sql ="SHOW TABLE STATUS LIKE 'isometadata'";

	$result = @mysql_query($sql,$connection)or die(mysql_error());

	$row = mysql_fetch_assoc($result);

	$MetadataID = $row['auto_increment'];

	//Enter the provided data into the ISO Metadata table
	$sql2 ="INSERT INTO  `isometadata`(`MetadataID`, `TopicCategory`, `Title`, `Abstract`, `ProfileVersion`, `MetadataLink`) VALUES ('$MetadataID', '$TopicCategory', '$Title', '$Abstract', '$ProfileVersion', '$MetadataLink')";
	...
	$num3 = @mysql_num_rows($result3);
	    ...
	    $msg = "<P><em2>A new MetadataID has been created!.</em></p>";
...
$num3 = @mysql_num_rows($result3);
    ...
    $msg2 = "<P><em2>A new Source has been created!.</em></p>";
    ...
    <td width="720" valign="top" bgcolor="#FFFFFF"><blockquote><br /><?php echo "$msg"; ?>
      ...
      <FORM METHOD="POST" ACTION="do_add_source.php" name="addsource">
        ...
        <tr>
          ...
          <td colspan="2" valign="top"><input type="text" id="Zip" name="Zip" size="5" maxlength="8"/></td>
          </tr>
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top">&nbsp;</td>
        ...
        <tr>
          ...
          <td valign="top"><input name="radio" type="radio" id="MetadataID" value="existing" checked></td>
...
<select name="MetadataID" id="MetadataID" onChange="showSites(this.value)">
  ...
  <?php echo "$option_block1"; ?>
        ...
        <tr>
          <td valign="top">&nbsp;</td>
          <td valign="top"><input type="radio" name="radio" id="MetadataID" value="new"></td>
