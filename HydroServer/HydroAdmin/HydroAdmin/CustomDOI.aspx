<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="CustomDOI.aspx.cs" Inherits="HydroAdmin.CustomDOI" %>
                            ...
                            <div class="art-Post-body">
                                ...
                                <div class="art-PostHeader">
                                    ...
                                    <div style = " z-index: 100;left : 0px; position: absolute; top: 0px;width:100%; border-style:groove; height:600px; overflow:auto" >
                                        <asp:GridView ID="resourceInfoDisplayGrid" runat="server" Font-Size="Small" 
                                            onrowcreated="resourceInfoDisplayGrid_RowCreated" 
                                            onprerender="resourceInfoDisplayGrid_PreRender">
                                        <HeaderStyle BorderStyle="Solid" CssClass="header" />
                                      <Columns>  
                                <asp:TemplateField HeaderText="Input ResourceId">
                                    <ItemTemplate>
                                        <asp:TextBox ID="customResourceIdTextBox" runat="server" Width="250"></asp:TextBox>
                                    </ItemTemplate>                    
                                </asp:TemplateField>
                                 <asp:TemplateField  HeaderText="Input MetadataId">
                                    <ItemTemplate >
                                        <asp:TextBox ID="metadataIdTextBox" runat="server" Width="250"></asp:TextBox>
                                    </ItemTemplate>                    
                                </asp:TemplateField>
                                            </Columns>
                                        </asp:GridView>
